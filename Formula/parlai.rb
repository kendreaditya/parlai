...
#
# After every release: bump url + sha256, regenerate resource blocks if deps changed.
class Parlai < Formula
  ...
  sha256 "35d1583271362f050766568c98daef0fc8e85527a2b0e883c3bdedbac57b0226"
  license "MIT"
  ...
  resource "gemini-webapi" do
    url "https://files.pythonhosted.org/packages/2c/2a/1d46470ec287f978565b000bf4fd9cc3eee8f4193ceec70094dc12a724a3/gemini_webapi-2.0.0.tar.gz"
    sha256 "5ee9d8ad9fd4c7fdc50ebfd152c9cf1dc4c30f7e9984bae6dffed9a0cb039735"
  end
